...
def create_cubesat_figure(rotation_matrix=None):
    ...
    traces = [go.Scatter3d(x=[e[0][0], e[1][0]], y=[e[0][1], e[1][1]], z=[e[0][2], e[1][2]], mode='lines',
                           line=dict(color='rgba(231, 58, 118, 1.0)', width=4)) for e in edges]  # Orange néon
    ...
    layout = go.Layout(
        scene=dict(
            xaxis=dict(
                ...
                showgrid=True,
                gridcolor='rgba(255, 255, 255, 0.1)',  # Grille en néon bleu clair
                gridwidth=1,
                zeroline=True,
                zerolinecolor='rgba(255, 255, 255, 0.1)',  # Ligne centrale en rouge néon
                zerolinewidth=2,
            ...
            yaxis=dict(
                ...
                gridwidth=1,
                zeroline=True,
                zerolinecolor='rgba(255, 255, 255, 0.1)',  # Ligne centrale en vert néon
                zerolinewidth=2,
            ...
            zaxis=dict(
                title='Z (cm)',
                title_font=dict(color='rgba(255, 255, 255, 1)', size=14), 
                tickmode='array',
                tickvals=[-10, 0, 10],
                ...
                gridwidth=1,
                zeroline=True,
                zerolinecolor='rgba(255, 255, 255, 0.1)',  # Ligne centrale en bleu néon
                zerolinewidth=2,
                tickcolor='rgba(0, 0, 255, 1)',  # Texte des axes en bleu néon
                tickfont=dict(color='rgba(255, 255, 255, 1)', size=12)
            ),
            camera=dict(
